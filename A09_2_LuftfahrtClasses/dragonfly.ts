...
*/
    export class Dragonfly {
        ...
        constructor(_posX: number, _posY: number, _speedX: number, _speedY: number, _color: string, _wingsUp: boolean, _id: number, _starter: boolean) {
            this.posX = _posX;
            this.posY = _posY;
            this.speedX = _speedX;
            this.speedY = _speedY;
        ...
        drawDragonfly(): void {
            ...
            if (this.starter) {
                ...
                if (this.posX < -canvasW * 0.1 || this.posX > canvasW * 1.1 || this.posY > canvasH * 1.05) {
                    delete allDragonflies[this.id]; // using splice caused weird side effects
