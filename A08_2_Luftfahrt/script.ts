...
*/
    ...
    function drawTree(_posX: number, _posY: number, _height: number): void {
        ...
        let gradient: CanvasGradient = crc2.createLinearGradient(0, 0, 0, -(_posY * 0.1) * _height);
    ...
    function drawHotAirBalloon(_posX: number, _posY: number): void {
    ...
    function drawDragonfly(_posX: number, _posY: number): void {
